...
public interface Organization {
    ...
    /**
     * Adds an existing employee under a specific supervisor.
     * Does not add the employee if the supervisor is not found.
     *
     ...
     *                       be an existing employee
     */
    void addContractEmployee(String name, double pay, Gender gender, int endDate, int endMonth, int endYear, String supervisorName);
    ...
    /**
     * Filters and returns employee names based on the specified predicate.
     *
     * @param predicate condition to filter employees.
     * @return filtered list of employee names.
     */
