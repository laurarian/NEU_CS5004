...
Notes: 
 *   This file defines the Person class, representing an individual with a first name, last name, and year of birth.
 *   The class includes methods to retrieve the first name, last name, and year of birth of a person.
