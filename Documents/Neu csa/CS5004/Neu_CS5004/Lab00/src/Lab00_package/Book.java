...
Notes: 
 *   This file defines the Book class, representing a book with a title, author, and price.
 *   The class includes methods to retrieve the title,author and price of a book.
